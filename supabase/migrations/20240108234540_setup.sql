...
AS $$
DECLARE
  project_url TEXT := 'https://bwnddnmstczdlojforqo.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJ3bmRkbm1zdGN6ZGxvamZvcnFvIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyNjE1MTI2NSwiZXhwIjoyMDQxNzI3MjY1fQ.wtYL2ob-LQlc3jpn968TgEgZptM7HSVXF-XDxWK_6lA'; -- full access needed for http request to storage
